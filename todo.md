...
- [x] Understand current UI structure and task management
- [x] Create manual task form component (ManualTaskForm.tsx)
- [x] Add button and modal to task window (Timeline.tsx)
- [x] Integrate with store and test (11 new tests passing)
